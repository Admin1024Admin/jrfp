...
/**
 * Resultsusing generated by hbm2java
 */
@Entity
@Table(name = "resultsusing", catalog = "audit", uniqueConstraints = @UniqueConstraint(columnNames = "year"))
public class ResultsUsing implements java.io.Serializable {
	...
	public ResultsUsing(int year, int state, String sumbitOne, String name, int editDpt) {
		this.year = year;
		this.state = state;
	...
	public ResultsUsing(int year, int state, String sumbitOne, String sumbitDate, String name, int editDpt, Integer td1,
