...
public class FpxexdDaoChu2 {
    ...
    public Sheet getSheet(Map<String,String> fieldsMap, List<String> fields,Map<String,Integer> numberMap,SXSSFWorkbook workbook){
       ...
       CellStyle style2 = workbook.createCellStyle();
        ...
        // 基本情况字段
        if(j!=0){
            CellRangeAddress region2 = new CellRangeAddress(1,1,(short)0,(short)(j-1));
        ...
        //原贷款情况
        if(y!=0){
            CellRangeAddress region3 = new CellRangeAddress(1,1,(short)j,(short)(j+y-1));
        ...
        //创建第二行 扶贫小额信贷
        if(f!=0){
            CellRangeAddress region4 = new CellRangeAddress(1,1,(short)(j+y),(short)(j+y+f-1));
        ...
        //创建第二行 创业贷款
        if(c!=0){
            CellRangeAddress region5 = new CellRangeAddress(1,1,(short)(j+y+f),(short)(j+y+f+c-1));
        ...
        //创建第二行 生源地贷款
        if(s!=0){
            CellRangeAddress region6 = new CellRangeAddress(1,1,(short)(j+y+f+c),(short)(j+y+f+c+s-1));
        ...
        //创建第二行 其他类型贷款
        if(q!=0){
            CellRangeAddress region7 = new CellRangeAddress(1,1,(short)(j+y+f+c+s),(short)(j+y+f+c+s+q-1));
     ...
     */
    @Async
    public void FpxexdDaoChu(Sheet sheet,List<String> fields,List<BaseFpxexd> fpxexds,SXSSFWorkbook workbook){
        Font font = workbook.createFont();
        //设置字体大小
        font.setFontName("宋体");
